...
class Scale (object):
    ...
    """
    def __init__(self, size, interpolation=Image.Resampling.BILINEAR, largest=False,
...
class RandomScale (Scale):
    ...
    def __init__(self, min_size, max_size, ar=1,
                 can_upscale=False, can_downscale=True, interpolation=Image.Resampling.BILINEAR):
...
class RandomRotation(object):
    ...
    def __init__(self, degrees, interpolation=Image.Resampling.BILINEAR):
...
class RandomTilting(object):
    ...
    def __call__(self, inp):
        ...
        img =  img.transform(img.size, Image.PERSPECTIVE, homography, resample=Image.Resampling.BICUBIC)
